...
#define BLANCO 2
// Parámetros servos
#define MAX_VEL_IZQ 180 // 180 -> Máx (funciona bien con 96 y 106)
#define MAX_VEL_DER 0 // 0 -> Máx (funciona bien con 71 y 61)
#define VEL_SOFT_IZQ 91 // 135 (funciona con 91)
#define VEL_SOFT_DER 76 // 45 (funciona con 76)
#define VEL_ATRAS_IZQ 81
#define VEL_ATRAS_DER 86
